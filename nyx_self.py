...
owner="u6dc040137eac599ca446f80f45bbd93c"
...
#------------AUTO_RESPOND_NAME---------------
        if op.type == 26:
          try:
            client.sendPesan(op.param2,"Kenapa Tag Gua?")
            client.blockContact(op.param2)
          except:
            pass
...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Liked By ZiAd\nhttps://line.me/ti/p/~anaichiro")
